...
/**
 * Configure the gRPC client sample.
 * <p>
 * Define the gRPC channel, message channels, and integration flows
...
class ClientHelloWorldConfiguration {
	...
	/**
	 * Create a managed gRPC channel for communication with the server.
	...
	/**
	 * Create a message channel for single response gRPC requests.
	...
	/**
	 * Create a FluxMessageChannel for output.
