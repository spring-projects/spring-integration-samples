...
public class Application {
	...
	@Bean
	@InboundChannelAdapter(value = "mqttOutFlow.input", poller = @Poller(fixedDelay="1000") )
	public CharacterStreamReadingMessageSource source() {
		return CharacterStreamReadingMessageSource.stdin();
	}

	@Bean(name="mqttOutFlow.input")
	public MessageChannel flowIn() {
		return new DirectChannel();
	}

	@Bean
	public IntegrationFlow mqttOutFlow() {
		return f -> f.transform(p -> p + " sent to MQTT")
				.handle(mqttOutbound());
	}
