...
public class PromiseTest {
	...
	public void testPromiseGateway() throws Exception{
		...
		for (int i = 0; i < 100; i++) {
			...
			Promise<Integer> result = gateway.multiplyByTwo(number);
			Consumer<Integer> success = new Consumer<Integer>() {
	...
	@MessagingGateway(defaultReplyTimeout = 0, reactorEnvironment = "env")
