...
import org.springframework.integration.samples.filesplit.Application;
...
public class ApplicationTests {
	...
	public void testSuccess() throws Exception {
		...
		assertThat(message).contains("/tmp/in/foo.txt");
	}
	...
	public void testFailure() throws Exception {
		...
		assertThat(message).contains("/tmp/out/002.txt");
	}
	 ...
	 */
	private String runTest(boolean fail) throws FileNotFoundException, IOException, InterruptedException, Exception {
